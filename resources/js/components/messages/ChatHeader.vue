                            ...
                            <div class="col-auto">
                                <div class="avatar d-none d-xl-inline-block">
                                    <img class="avatar-img" id="chat-avatar"
                                        :src="conversation ? conversation.participants[0].avatar_url : ''">
                                </div>
                            </div>

                            <div class="col overflow-hidden">
                                <h5 class="text-truncate" id="chat-name">{{ conversation ?
                                            conversation.participants[0].name : '' }}</h5>
                                <p v-if="conversation.participants[0].isTyping" class="text-truncate">is typing<span
                            ...
                            <div class="col-auto">
                                <!-- <div class="avatar-group">
                                    ...
                                    <a href="#" class="avatar avatar-sm" data-bs-toggle="offcanvas"
                                        ...
                                        <span class="avatar-text" data-bs-toggle="tooltip" data-bs-placement="bottom"
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item" href="#" data-bs-toggle="offcanvas"
                                data-bs-target="#offcanvas-add-members" aria-controls="offcanvas-add-members">Add
                                members</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="#" data-bs-toggle="offcanvas"
