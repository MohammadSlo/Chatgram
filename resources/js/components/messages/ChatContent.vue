                        ...
                        <div class="message-body">
                            <div class="message-content">
                                ...
                                <div class="message-gallery"
                                    v-if="message.type == 'attachment' && message.body?.mimetype?.match(/image\/.+/)">
                                    <div class="row gx-3">
                                        <div class="col">
                                            <img class="img-fluid rounded"
                                                v-bind:src="'/storage/' + message.body.file_path" data-action="zoom"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="message-text"
                                    ...
                                    <div class="message-text">
                                        ...
                                        <div class="row align-items-center gx-4">
                                            <div class="col-auto">
                                                <a v-bind:href="'/storage/' + message.body.file_path"
                                            ...
                                            <div class="col overflow-hidden">
                                                ...
                                                <ul class="list-inline text-uppercase extra-small opacity-75 mb-0">
                                                    <li class="list-inline-item">{{ Number(message.body.file_size /
                    1024).toFixed(2) }} KB</li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center text-danger" href="#">
                                                    <span class="me-auto"
                                                        @click.prevent="$root.deleteMessage(message, 'me')">Delete for
                                                        me</span>
                                                    <!-- 
                                                    <div class="icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center text-danger" href="#">
                                                    <span class="me-auto"
                                                        @click.prevent="$root.deleteMessage(message, 'all')">Delete for
                                                        everyone</span>
                                                    <!-- <div class="icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
...
export default {
    ...
    updated() {
        if (this.conversation && this.fetchedConversation != this.conversation.id) {
            fetch(`/api/conversations/${this.conversation.id}/messages`)
                .then(response => response.json())
                .then(json => {
                    this.$root.messages = json.messages.data.reverse();
                    this.fetchedConversation = this.conversation.id;
