<template>
    <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
        ...
        <form class="chat-form rounded-pill bg-dark" data-emoji-form="" method="POST" action="/api/messages"
            ...
            <input type="hidden" name="conversation_id" :value="converstaion ? converstaion.id : 0">
                ...
                <div class="col">
                    <div class="input-group">
                        <textarea name="message" v-model="message" @focus="$root.markAsRead()" @keypress="startTyping()"
                            class="form-control px-0" placeholder="Type your message..." rows="1" data-emoji-input=""
    ...
    methods: {
        ...
        selectFile() {
            ...
            fileElement.addEventListener('change', () => {
                ...
                this.attachment = fileElement.files[0];
                this.sendMessage();
            });
            fileElement.click();
        }
